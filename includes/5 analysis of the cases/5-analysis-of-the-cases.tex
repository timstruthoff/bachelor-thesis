...
\begin{figure}\label{nda-graph}
  \begin{center}
      \input{includes/5 analysis of the cases/figures/dtcnda-plot.pgf}
  \end{center}
...
\begin{figure}\label{dtcnda-correlation-graph}
  \begin{center}
      \input{includes/5 analysis of the cases/figures/dtcnda-correlation-plot.pgf}
  \end{center}
...
\begin{figure}\label{ingrid-graph}
  \begin{center}
      \input{includes/5 analysis of the cases/figures/ingrid-plot.pgf}
  \end{center}
...
\begin{figure}\label{ingrid-correlation-graph}
  \begin{center}
      \input{includes/5 analysis of the cases/figures/ingrid-correlation-plot.pgf}
  \end{center}
...
\begin{figure}\label{alstonii-graph}
  \begin{center}
      \input{includes/5 analysis of the cases/figures/alstonii-plot.pgf}
  \end{center}
...
\begin{figure}\label{alstonii-correlation-graph}
  \begin{center}
      \input{includes/5 analysis of the cases/figures/alstonii-correlation-plot.pgf}
  \end{center}
...
\begin{figure}\label{lacustris-graph}
  \begin{center}
      \input{includes/5 analysis of the cases/figures/lacustris-plot.pgf}
  \end{center}
...
\begin{figure}\label{lacustris-correlation-graph}
  \begin{center}
      \input{includes/5 analysis of the cases/figures/lacustris-correlation-plot.pgf}
  \end{center}
...
\begin{figure}\label{engelmanii-correlation-graph}
  \begin{center}
      \input{includes/5 analysis of the cases/figures/engelmanii-correlation-plot.pgf}
  \end{center}
...
\begin{figure}\label{gitlab-correlation-graph}
  \begin{center}
      \input{includes/5 analysis of the cases/figures/gitlab-correlation-plot.pgf}
  \end{center}
