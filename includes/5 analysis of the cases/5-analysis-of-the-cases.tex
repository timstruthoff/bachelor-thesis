...
In einem nächsten Schritt wurden wie in 4.5 und 4.7 beschrieben die
Korrelationskoeffizienten berechnet. Diese können Tabelle .. entnommen
werden.

TODO

Für alle Untersuchungsergebnisse wurde ein P-Wert von \textless{} .00001
ermittelt\footcite[Vgl. ][]{\url{https://www.socscistatistics.com/pvalues/pearsondistribution.aspx}}.
...
Aufwandsabschätzungen beschrieben. Diese geschieht anhand der, in 4.4
beschriebenen User Storys. Von besonderem Interesse für die Analyse sind
...
der Story geschätzt. Mit dem, in 3.2 beschriebenen
...
Abweichend von der in 3.2 beschriebenen Vorgehensweise werden in diesem
...
einer Story beinhaltet\footcite[Vgl. ][]{Interview mit Entwickler der inGRID Software}. Es kann also mit diesem Feld
gesagt werden, wann der, in der User Story spezifizierte Aufwand in die
Anwendung geflossen ist. In dem Experteninterview\footcite[Vgl. ][]{Interview
  mit Entwickler der inGRID Software} mit einem der Entwickler konnte an dieser Stelle eine
...
Abfragesprache SQL angelehnt\footcite[Vgl. ][]{\url{https://support.atlassian.com/jira-service-management-cloud/docs/use-advanced-search-with-jira-query-language-jql/}}.
...
Das Engelmannii Projekt\footnote{Engelmannii Zeile 5} wird von der
...
Zur Ermittlung der Codekomplexitätsmetriken ist, wie in Kapitel 4
