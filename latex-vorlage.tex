...
\input{includes/0-preface/0.1-deckblatt.tex}
...
\tableofcontents
\clearpage
\input{includes/0-preface/0.3-abkuerzungen.tex}
...
\input{includes/1 introduction/1-introduction.tex}
\input{includes/2 software complexity measures/2-softwarecomplexity-measures.tex}
\input{includes/3 effort estimates/3-effort-estimates.tex}
\input{includes/4 research setup/4-research-setup.tex}
\input{includes/5 analysis of the cases/5-analysis-of-the-cases.tex}
\input{includes/6 summary of findings/6-summary-of-the-findings.tex}
\input{includes/7-conclusion/7-conclusion.tex}
